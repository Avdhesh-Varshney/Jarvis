...
@st.cache_data
def load_data():
  gdown.download(f"https://drive.google.com/uc?id={st.secrets["google_drive"]["MOVIES_LIST"]}", 'movies_list.pkl', quiet=False)
  gdown.download(f"https://drive.google.com/uc?id={st.secrets["google_drive"]["SIMILARITY"]}", 'similarity.pkl', quiet=False)
