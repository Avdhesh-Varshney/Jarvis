...
@st.cache_resource
def load_model():
  model = tf.keras.models.load_model('src/apps/pages/models/ObjectDetectionModels/MaskDetectionModel/maskcheck.keras')
  return model
...
def maskDetectionModel():
  cnn = load_model()
  modelFile = "src/apps/pages/models/ObjectDetectionModels/MaskDetectionModel/res10_300x300_ssd_iter_140000.caffemodel"
  configFile = "src/apps/pages/models/ObjectDetectionModels/MaskDetectionModel/deploy.prototxt"
